...
// language.
export function ViewHeader({ icon: Icon, title, subtitle }: { icon: LucideIcon; title: string; subtitle: string }) {
  return (
    <div className="flex flex-none items-center gap-2.5 border-b border-border px-6 py-3.5">
      <Icon className="size-[17px] flex-none text-ink3" aria-hidden="true" />
