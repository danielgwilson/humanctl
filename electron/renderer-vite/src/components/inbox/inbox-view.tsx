...
// Ported from inbox.js's render(): the two-pane Inbox shell (thread list +
...
// invariant in inbox.js's render() comment).
  ...
  return (
    <div className="grid h-full grid-cols-[340px_1fr]">
      ...
      <section className="min-h-0 min-w-0 overflow-hidden">
        <ThreadDetail thread={selected} byId={byId} onAsk={onAsk} />
      </section>
    </div>
  );
}
