// Pure inbox derivation logic, ported from electron/renderer/inbox.js so the
// spike's Inbox view matches the static renderer's row anatomy, filtering,
// and sort behavior exactly (DESIGN.md "Row anatomy" section).
