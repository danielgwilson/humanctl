...
const COMMANDS = [
  ...
  },
  {
    ...
    params: { mode: { type: 'string', required: true, enum: ['focus', 'triage', 'wall'] } },
  },
  {
  ...
  {
    name: 'app.mark-read', kind: 'action',
    desc: 'mark the inbox read (stores notesReadAt; the UI does not consume it yet)',
    params: {},
  },
  {
